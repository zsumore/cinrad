...
public class Cinrad {
	...
	public Cinrad(URL url) throws DecodeException, UnSupportProductException,
			IOException, FactoryException {
		this(url, null);

	}

	public Cinrad(URL url, Integer sid) throws DecodeException,
			UnSupportProductException, IOException, FactoryException {
		this(url, sid, null);
	}

	public Cinrad(URL url, Integer sid, Map<String, Object> decodeHints)
			throws DecodeException, UnSupportProductException, IOException,
			FactoryException {
		if (url != null) {
			if (sid != null) {
			...
			default:
				...
				throw new UnSupportProductException(
						"This product is not support:" + pcode);
			}
	...
	public static boolean isSupport(int pcode) {
		if (pcode == 19 || pcode == 20 || pcode == 25 || pcode == 26
				|| pcode == 27 || pcode == 28 || pcode == 30 || pcode == 36
				|| pcode == 37 || pcode == 38 || pcode == 41 || pcode == 43
				|| pcode == 44 || pcode == 46 || pcode == 48 || pcode == 53
				|| pcode == 56 || pcode == 57 || pcode == 58 || pcode == 59
				|| pcode == 60 || pcode == 61 || pcode == 62 || pcode == 65
				|| pcode == 66 || pcode == 78 || pcode == 79 || pcode == 80
				|| pcode == 110)
			return true;
