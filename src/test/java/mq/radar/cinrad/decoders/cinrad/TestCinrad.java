...
public class TestCinrad {
	...
	public static void main(String[] args) throws DecodeException, IOException,
		...
		String file19 = "data/20130717.000000.01.20.200";
		String file20 = "data/20110916/R/20/20110916.043001.01.20.200";
		String file26 = "data/20111013.220001.01.26.200";
		String file27 = "data/20110916/V/27/20110916.043001.01.27.200";
		...
		context.getViewport().setCoordinateReferenceSystem(
				MQProjections.getInstance().getWGS84CoordinateSystem());
		context.getViewport().setBounds(
				new ReferencedEnvelope(header.getCinradBounds(), MQProjections
						.getInstance().getWGS84CoordinateSystem()));

		Color[] colors = CinradColorFactory.getColors(header.getProduct());
		context.addLayer(new FeatureLayer(decode.getFeatures(),
				createPolygonStyle(colors)));
	...
	private static Rule createRule(StyleFactory sf, FilterFactory ff,
			Color fillColor) {
		Symbolizer symbolizer = null;
		Fill fill = null;
		Stroke stroke = sf
				.createStroke(ff.literal(fillColor), ff.literal(1.0f));
